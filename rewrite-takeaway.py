...
filepath = "/Users/nimeshranjan/DBC/dream-bean-cafe/src/app/dashboard/takeaway/page.tsx"
        ...
        <div className="flex-1 overflow-y-auto p-6 bg-slate-50/50">
          <div className="max-w-5xl mx-auto space-y-4">
            {ordersLoading ? (
               ...
               <div className="text-center text-slate-500 py-20 bg-white rounded-2xl border border-slate-200 shadow-sm">
                     ...
                     <div className="grid grid-cols-2 gap-2 mt-auto">
                       {(order.status === 'pending' || order.status === 'preparing') ? (
                         ...
                         <>
                           ...
                           <button onClick={() => handlePayment(order.id, 'upi')} className="bg-blue-50 text-blue-700 border border-blue-200 font-bold py-2.5 rounded-xl hover:bg-blue-100 transition-colors">Collect UPI</button>
                         </>
                       ) : (
